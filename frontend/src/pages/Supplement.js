...
const Supplements = () => {
  ...
  supplementsSalesData?.supplementSales?.filter((data) => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="h5">Supplements Sales Records</Typography>
      </Box>
      <Box
        sx={{
          height: "100%",
          ...
          >
            <Grid container sx={{ height: "100%", width: "100%" }}>
              <Grid item xs={12} sx={{ height: "70px" }}>
                ...
                >
                  Create Supplement Sale Receipt
                </Typography>
              </Grid>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={4}>
                      <FormControl sx={{ width: "100%" }}>
                        ...
                        >
                          {supplementsData &&
                            supplementsData?.supplement?.map((util) => (
                    ...
                    <Grid item xs={12}>
                      {selectedMonthSales?.length > 0 ? (
                        <UtilsSalesTable
                          ...
                          deleteSupplementSales={deleteSupplementSales}
                        />
                      ) : (
                        <Box
                          sx={{
